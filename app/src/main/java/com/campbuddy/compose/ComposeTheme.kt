...
val md_theme_light_inverseSurface = Color(0xFF363636)
...
val md_theme_dark_onBackground = Color(0xFFEBEBEB)
val md_theme_dark_surface = Color(0xFF212121)
val md_theme_dark_onSurface = Color(0xFFEBEBEB)
...
val md_theme_dark_inverseSurface = Color(0xFFEBEBEB)
